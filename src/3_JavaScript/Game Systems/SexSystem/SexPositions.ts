...
(function(): void {
  const pos = {
    ...
    cowGirl: {
      ...
      movText: "you climb atop <<= ↂ.T.main.name>>, straddling <<n _t 'himher'>> before lowering your <<p curwet.s>> <<p vulva.n>> onto <<n _t 'hisher'>> <<n _t 'cockhead.q'>> <<n _t 'cockhead.n'>>.", // sentence fragment
      group: "laying", // standing sitting laying
      label: ".Ride Cowgirl.",
      hover: "Climb aboard your partner and ride <<n _t 'himher'>> like a cowgirl.",
      img: "IMGsexP_sittingChair",
      cat: "sex", // makeout, oralPC, oralNPC, sex
      basic: "lay",
      kink: ["none"],
      min: 2, // incl PC
    ...
    RevCowgirl: {
      ...
      movText: "you climb atop <<= ↂ.T.main.name>>, straddling <<n _t 'himher'>> and taking a good look at <<n _t 'hisher.q'>> package before lowering your <<p curwet.s>> <<p vulva.n>> onto <<n _t 'hisher'>> <<n _t 'cock.q'>> <<n _t 'cock.n'>>.", // sentence fragment
      group: "laying", // standing sitting laying
      label: ".Reverse Cowgirl.",
      hover: "Climb aboard your partner and ride <<n _t 'himher'>> like a cowgirl, only in reverse.",
      img: "IMGsexP_sittingChair",
      cat: "sex", // makeout, oralPC, oralNPC, sex
      basic: "lay",
      kink: ["none"],
    ...
    layingBJposition: {
      ...
      desc: "You're on your hands and knees, straddling <<= ↂ.T.main.name>>'s legs with your face directly over <<if ↂ.T.main.male>><<n _t 'hisher.q'>> <<n _t 'cock.s'>> <<n -t 'cock.n'>> and <<n _t 'balls.s'>> <<n _t 'balls.n'>>.<<else>><<n _t 'hisher.q'>> <<n _t 'curwet.q'>> <<n _t 'vulva.n'>>.<</if>>",
      movText: "scoot down and straddle <<n _t 'hisher.q'>> legs until your face is mere <<if $metric>>centimeters<<else>>inches<</if>> from <<if ↂ.T.main.male>><<n _t 'hisher.q'>> <<n _t 'cock.s'>> <<n -t 'cock.n'>> and <<n _t 'balls.s'>> <<n _t 'balls.n'>>.<<else>><<n _t 'hisher.q'>> <<n _t 'curwet.q'>> <<n _t 'vulva.n'>>.<</if>>", // sentence fragment
      group: "laying", // standing sitting laying
    ...
    layingMunchPosition: {
      ...
      desc: "You're laying on your back with your legs spread, while <<= ↂ.T.main.name>> has <<n _t 'hisher'>> head between them.",
    ...
    SixtyNinePConTop: {
      ...
      movText: "turn around and climb over <<= ↂ.T.main.name>> so that you're straddling <<n _t 'hisher.q'>> face, with your own face hovering over <<if ↂ.T.main.male>><<n _t 'hisher.q'>> <<n _t 'cock.s'>> <<n -t 'cock.n'>> and <<n _t 'balls.s'>> <<n _t 'balls.n'>>.<<else>><<n _t 'hisher.q'>> <<n _t 'curwet.q'>> <<n _t 'vulva.n'>>.<</if>>", // sentence fragment
      group: "laying", // standing sitting laying
      label: "Sixty-Nine",
