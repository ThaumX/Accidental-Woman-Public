...
setup.nameRandomizer = function(sex,race){
  var list = ["error"],cock = 0;
  switch(race){
    case "white":cock=1;break;
    case "Gaelic":cock=1;break;
    case "Nordic":cock=1;break;
    case "black":cock=2;break;
    case "native American":cock=1;break;
    case "middle eastern":cock=3;break;
    case "hispanic":cock=4;break;
    case "southern European":cock=4;break;
    case "southeast Asian":cock=5;break;
    case "Asian":cock=5;break;
    case "south Asian":cock=6;break;
  }
  var t = random(1,10);
  if(cock == 5 && t > 8){cock = 1;}
  if(cock == 6 && t > 9){cock = 1;}
  if(cock == 4 && t > 9){cock = 1;}
  if(cock == 2 && t > 9){cock = 1;}
  if(sex == 1 || sex == 4){
...
setup.surnameRandomizer = function(race){
  ...
  if(State.active.variables.npcSetting.names[0] && State.active.variables.npcSetting.names[3].length > 0){
    ...
    switch(race){
      ...
      case "Nordic":cock=1;break;
      case "black":cock=2;break;
      case "native American":cock=2;break;
      case "middle eastern":cock=3;break;
      case "hispanic":cock=4;break;
      case "southern European":cock=4;break;
      case "southeast Asian":cock=5;break;
...
setup.deepThoughts = function(num){
  ...
  if(num == 0){
    ...
    r = eval(num);
    if(r >= list.length){r = r % list.length;}
  }else{
    r = num;
  }
  return list[r];
...
setup.clothSort = function(arr,j){
  let list = [],v=[],length = arr.length,t;
