...
setup.mapEvents.events = {
  world: {
    generic: [
      ...
      "You feel a smell of fresh baking.",
      "You watch clouds running fast in the sky.",
      "You smell the freshness of a recent rain.",
    ],
    appletree: [
      ...
      "You see a sun reflecting from a shop’s window case.",
      "You admire a brand new model car passing by.",
      "You see straight rows of decorative trees, all the same size.",
    ],
    institute: [
      ...
      "You hear a constant scratching sound from a door which seems abandoned.",
      "Ceiling lamps are too bright.",
      "You breathe dry conditioned air.",
    ],
    restricted: [
      ...
      "It smells medicine.",
      "It seems to you that you’ve heard a baby cry.",
      "It’s too sterile here.",
    ],
    coop: [
    ...
    lake: [
      ...
      "The wind slightly touches the water surface.",
      "The water is so transparent that you can see the sandy bottom.",
      "A school of small fish is swiftly swimming away.",
    ],
    visitor: [
      ...
      "You hear a group of young ladies chatting, but cannot catch what they are talking about.",
      "You see a guy buying a postcard at street-open showcase. @@.npc;What a nice view of the valley! I’ll probably take two of these.@@",
      "You see Appletree touristic maps sold $1 per sheet.",
    ],
    forest: [
      ...
      "You can hardly see the sky because of branches interweaving tightly upon your head.",
      "The grass is springing underfoot.",
      "A bird bothered by your appearing flies up from the high grass.",
    ],
    woods: [
      ...
      "Trees are tall and old.",
      "Bushes are strewn by small red berries.",
      "Wind slightly whistles around",
    ],
    unknown: [
    ...
    city: [
      ...
      "The lawns of nearby houses are clean and tidy.",
      "Few people are seen in the streets.",
      "You mention the lack of stray animals.",
    ],
    spring: [
    ...
    bridge: [
      ...
      "The water is so silent that you can see your reflection far below.",
      "A small boat with a young couple sails by. You hear fragments of their talk. @@.npc;...better ask me first!@@ @@.npd;I was sure you’d love it!@@ @@.npc;We’ve been dating for a year already! How damn don't you know I’m afraid of open water?!@@",
      "A bird flies low over the water surface.",
    ],
    resort: [
      ...
      "Several young people with a bronze tan are playing beach volleyball.",
      "Children are splashing in a smaller pool.",
      "You feel a smell of a sun-protecting oil.",
    ],
    main: [
      ...
      "It’s too silent around.",
      "You feel anxious a bit.",
    ],
  },
  bullseye: {
      generic: [
        ...
        "You notice the total absence of crowds and lines.",
        "You see a family shopping. @@.npc;I want this one, moooom! I do want this!@@ @@.npd;It’s not your size, dear. It’s too big.@@",
      ...
      parking: [
        ...
        "The sun has heated the cars so you can see hot air trembling upon them.",
        "There are not too many cars, but all of them are very clean.",
        "You mention cameras and got a feeling that they watch every step of yours.",
      ],
      hardware: [
        ...
        "You see two men walking along the shelves. They are showing off in front of one another pretending to be professionals. @@.npc;I would never use this one. No one aware of the thing would. The consuming power is too high if compare with the outcoming one.@@ @@.npd; But look at the steel! Isn’t it of the highest quality?@@",
        "You see a woman grabbing handfuls of tiny nails into a plastic bag. You wonder what for she may need so many of them.",
        "A girl is taking a selfie with a huge hammer.",
      ],
      electronics: [
        ...
        "Kitchen electronics row looks more like an exhibition of devices from a sci-fi show.",
        "You see a group of children chatting loudly around a brand-new Japanese playing console.",
        "A woman in a suit has squatted in front of laptop descriptions.",
      ],
      toys: [
        ...
        "A teenage boy is trying to choose the board game, deciding between the Monopoly and the Carcassonne. Finally, he makes a decision and buys the Uno.",
        "You stop in front of the dollhouse. It is so accurately made and the details are so tiny and realistic that you almost want to buy it and go play with it immediately",
        "You mention a shelf with inch-size figures of animals and trees. You guess they are rather for adult nerds playing tabletop games than for real children. @@.mono;The only thing a child can do with one of these is swallowing it and getting suffocated.@@",
        "Some of the toy rifles are comparable with the real ones in price.",
      ],
      baby: [
        ...
        "You mention a choice of baby soothers. @@.mono;Who in the world would ever buy a black one?@@",
        "Two ladies of middle age are certainly touched by the look of the smallest pants and T-shirts.",
        "They even have books for infants. They are square and chewing.",
      ],
      grocery1: [
        ...
        "You see giant red apples, all the same size. @@.mono;I’m sure they are not natural and have a taste of a grass.@@",
        "Vegetables marked 'Healthy right from the farm' are twice more expensive than the other ones.",
        "Some of the cans are covered with a thick layer of dust",
      ],
      grocery2: [
        "You see a woman staring at the cucumbers with a dumb mesmerized look.",
        "You look at small yellow lemon-like fruits. The price tag says that they are called 'Kumquats'. @@.mono;I wonder if they are tasty?@@",
        ...
        "You see a shelf full of chocolates. @@.mono;How many tastes! Wait, the sea salt? They must be kidding.@@",
        "You look at cans with Chai and Açai hiding the desire to buy them.",
        "It seems that the smaller a coffee can is, the higher it costs.",
      ],
      grocery3: [
        "You see a woman staring at the cucumbers with a dumb mesmerized look.",
        "You look at small yellow lemon-like fruits. The price tag says that they are called 'Kumquats'. @@.mono;I wonder if they are tasty.@@",
        ...
        "Mixed nuts jars are a size of a bucket",
        "You walk along the rows of spices. @@.mono;What is so special about saffron that it is so abnormally expensive?@@",
        "Greens seem faded.",
      ],
      housewares1: [
        ...
        "Beach towels and umbrellas are sold with a big discount. @@.mono;Does this mean the season is over?@@",
        "You always wanted to buy the biggest tea mug among all the tableware but you never did.",
        "It seems that now you need a special type of washing powder for every color of clothes.",
      ],
      housewares2: [
        ...
        "You see a set of professional cuisine chef-knives. They are beautiful.",
        "Rubber gloves unpleasantly remind of doctors’ examinations.",
        "Baking dishes are of different forms. Very different. Some are rather realistic.",
      ],
      womens1: [
        ...
        "You pass along ladies’ tops. @@.mono;Is pink popular again?@@",
        "You are eager to try that light and flowing garment on.",
        "Ladies sportswear seems more like a party outfit.",
      ],
      womens2: [
        ...
        "You mention that there’s no difference between women's and men's jeans but in the side the fly zips.",
        "You stop in winter jackets section. The eco fur seems to be more popular than the natural one.",
        "You walk and conclude that sleepwear is the coziest and the most comfortable ladies’ wear from all.",
      ],
      lingerie: [
        ...
        "You see the dummy dressed in a swimsuit. It looks so realistic that you were almost ready to talk with it taking the dummy to the real woman.",
        "You notice that bright colors of bras are popular again.",
        "String and thong-type lingerie are so narrow that you could hardly imagine someone wearing it with comfort.",
        "You see a lady holding at least a dozen models of bras and looking around in search of a changing room.",
      ],
      girls: [
        ...
        "You notice an adult lady choosing girls’ clothes obviously for herself because she’s applying items to her body in front of the mirror.",
        "There are fewer princesses and more superheroes prints on girls’ wear.",
        "You doubt you would let your daughter wear some of these.",
      ],
      boys: [
        ...
        "You observe boys’ jeans. White and beige ones seem like something very unpractical.",
        "Some fabric these items made of seem to be synthetics.",
        "Boys’ trousers have pockets for a lighter and a cigarette pack. @@.mono;Wait, what?@@",
      ],
      mens: [
        ...
        "You notice some women choosing clothes in men’s section.",
        "There are lots of caps and hats saying 'I heart Appletree' on them.",
        "There are fewer customers in men’s section than in women’s one.",
      ],
      pharmacy: [
        ...
        "You observe big packs with all sorts of vitamins with a touch of doubt. @@.mono;How could humankind go without all of them before?@@ Your inner voice definitely sounds sarcastic now.",
        "You are surprised to know that sleeping pills have more than a dozen different effects.",
        "The section is radiant pink of collagen packs.",
      ],
      glasses: [
        ...
        "You try on thick glasses and feel dizzy.",
        "You think first that sunglasses with bright plastic rims are for children, but then realize they are not.",
        "The highest price here is comparable with the cost of a medium-size house.",
      ],
      barber: [
        ...
        "You see a guy being colored blond. It’s a long process.",
        "The music is repeating and annoying.",
        "It smells that very essential hairdressers’ smell. You recognize it easily but for the life’s sake will never answer what exactly it smells.",
      ],
      custserv: [
        ...
        "А couple is arguing nearby. He wants to return the coffee maker they purchased last week, but she prefers not to make troubles.",
        "There’s a line, but the manager doesn't seem to hurry.",
        "@@.npc;On behalf of the convenience store we apologize and hope...@@ It seems that tired lady at the counter is repeating this for the hundredth time.",
      ],
      produce: [
        "",
        "",
      ...
      changing: [
        ...
        "You wonder if the rumor that there are hidden cameras in mirrors is true.",
        "You see a group of girls trying on clothes. They discuss each other’s looks and don’t bother to close curtains.",
        "There are plastic plates with numbers hanging on the wall used to indicate the number of items you bring to the changing room. No one is using them.",
      ],
  },
  residential: {
    generic: [
      ...
      "It is rather green around.",
      "The sun warms your face through the window.",
      "You are surprised not to hear the constant sounds of cars.",
    ],
    common: [
      ...
      "It smells dust.",
      "The stairs are creaking mildly and cozily. The building is new and you wonder if it is done on purpose.",
      "The color of the walls is yellow and turquoise. It’s unusual comparing with dull green or lousy brown.",
    ],
    gym: [
      ...
      "It smells perfume in the changing room.",
      "There are Female, Male, and Common shower rooms.",
      "You notice a guy riding an exercise bike. He’s been doing it all time you are visiting the room.",
    ],
    party: [
      ...
      "There are several burnt spots on the coffee table.",
      "You see some pillows and the blanket on the sofa in the corner.",
      "You see some retro green lamps on the walls.",
    ],
    main: [
      ...
      "Your mailbox is painted pink.",
      "You see dry dying plant on the sill. @@.mono;I think I should water the poor thing.@@",
      "You see a big metal box in the basement. You hear strange constant buzz coming from it.",
    ],
    parking: [
      ...
      "You are pleasantly surprised that there is always space in the parking though distinct places do not belong to distinct apartments.",
      "The sun has heated the cars so hard that you can see the air trembling above.",
      "You mention a black car with shadowed windows. You can swear you’ve seen it before several times in Appletree but no one has ever entered or left it.",
    ],
    sidewalk: [
      ...
      "The street lights here are switching on reacting on your approach. It looks like the spotlight is following you wherever you go.",
      "A big fluffy cat is passing by slowly. You have time to notice the inscription on its collar. ‘I’m not homeless or lost. See my address on the opposite side.",
      "It smells cherry blossom.",
    ],
    cumandgo: [
      ...
      "The lubricants on water base seem to be more popular though silicone ones are cheaper.",
      "A big guy is standing in front of a beer refrigirator.",
    ],
    recreation: [
      ...
      "A guy wearing nothing but pants is playing frisbee with his dog.",
      "A lonely boy reading a book seems rather strange among all these relaxing people.",
      "A teenage couple is busy applying sun-protecting cream on each other’s skin. Soon they seem to forget that they are not alone.",
    ],
    walkdowntown: [
      ...
      "The traffic lights are equipped with buttons letting you go and a panel counting down the time left to wait.",
      "Signposts showing the direction to Thornton office are literally everywhere.",
      "The bookcrossing shelf is sadly empty.",
    ],
    jogging: [
      ...
      "You see the bicycle lane going along with the jogging path.",
      "You notice a slightly dressed girl skating.",
      "You frown when seeing a guy listening to the music loudly from his wireless speaker.",
    ],
    reservoir: [
      ...
      "A couple of women ride the jet ski across the reservoir.",
      "It’s cooler and fresher here than in downtown.",
      "You notice a strange object sticking up out of water. @@.mono;Is it really a human arm there?@@ @@.pc;Hey? Anybody there?@@ @@.mono;Huh, it is definitely just a tree branch or a stick.@@",
      "@@.mono;It is not deep but what if I fall?@@",
    ],
    medical: [
      ...
      "You see an advertisement telling you how great you will look after the plastic surgery.",
      "Constant PA announcements merge into a monotonous noise.",
      "You hear the helicopter sound approaching and realize that one has just landed onto the hospital roof.",
    ],
    industrial: [
      ...
      "You see many gates when you walk along the concrete fence, but all seem locked.",
      "The truck drives by and douches you with mud.",
      "You see a building under construction and wonder what it’s gonna be when finished.",
    ],
    government: [
      ...
      "Appletree City Hall looks majestically.",
      "There are flags of USA and Appletree everywhere.",
      "The building of the Archive looks like a fortress. It is surprisingly well guarded.",
    ],
  },
  ...
  homeT1: {
    ...
    balcony: [
      ...
      "You notice the woman on the next balcony. Seeing you, she nods and blows you a kiss. @@.mono;She looks pretty, after all.@@",
    ],
    bedroom: [
  ...
  homeT3: {
    generic: [
      ...
      "You have turned on the ceiling light. The old-fashioned crystal chandelier is now like liquid sunshine.",
    ],
    kitchen: [
      "You open the fridge for no particular reason and stare inside blankly for some time.",
      "The kitchen sink makes a weird sound.",
    ...
    balcony: [
      ...
      "Two swarthy guys on the opposite balcony smoke long hoses attached to the tall bottle. The water is loudly bubbling inside it. @@.mono;This thing is called a hookah, as far as I know.@@",
    ],
    bedroom: [
      "The sunlight spot slowly moves across the bedroom.",
      "It gets unnaturally silent for some time.",
    ...
    bed2: [
      ...
      "Sometimes you ask yourself why you have three bedrooms in one-person apartments. Even the luxury should be reasoned.",
    ],
    bed3: [
      "The sunlight spot slowly moves across the bedroom.",
      "It gets unnaturally silent for some time.",
  ...
  downtown: {
    ...
    holefoods: [
      ...
      "You see a younger man along with a mature woman chatting in the vegetable section. @@.npd;...but...@@ @@.npc;Yes you will, that is my last word. Don't make me buy a ginger root for your butt again. Last time you whimpered like a little boy you are remember?@@ @@.npc;...yes mistress...sorry mistress...@@",
    ...
    bank: [
      ...
      "A group of women are discussing stock funds.",
    ...
    mall: [
      "A couple of women are trying to find a shopping cart without a broken wheel.",
      ...
      "You notice the ice cream stall next to the entrance. A teenage boy has just bought a snow cone for his girlfriend. She gratefully smiles, and her escort looks like he is over the moon.",
    ],
    foodcourt: [
      ...
      "You see a little crowd at the counter of ‘Soyburger Queens’. The home cooking canteen nearby is almost empty. @@.mono;This is the future of foodservice. The cheap plastic sandwiches become more popular than the expensive natural food.@@",
    ...
    movies: [
      ...
      "The large display shows the trailer of the new porno thriller ‘Hucow Run’. You hear a voice-over. @@.npc;The beautiful young hucow finds out that her master is going to stop milk production and to slaughter his cattle for meat. She urges her fellows to raise a riot, but the cunning rancher does not mess around...@@",
    ...
    west: [
      "You hear an ice cream van chimes from afar.",
    ...
    northeast: [
      ...
      "A cyclist has rode in puddles, dousing the fashionably dressed guy with dirty water. @@.npc;Hey! You fucking son of a bitch!@@",
