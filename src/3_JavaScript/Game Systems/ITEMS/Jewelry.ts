...
(function() {
  const jews = {
    ...
    fertilityBracelet: {
      ...
      cost: 120,
      type: "norm",
      image: "IMGjewelFertilityBracelet",
    },
    diamondStuds: {
    ...
    InfinityNecklace: {
      ...
      long: "Silver necklace with infinity symbol decorated with fake diamonds.",
      slot: "neck",
      atr: 2,
      cost: 55,
      type: "none",
    ...
    LeatherChocker: {
      ...
      long: "Leather choker with heart symbol, was pretty popular last decade.",
      slot: "neck",
      atr: 3,
      cost: 70,
      type: "slut",
