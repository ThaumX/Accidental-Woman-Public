...
aw.tagContent.enemy.NakedBottomMumble = [
  `<<stress 15 "Naked Pussy Convo">>@@.pc;Well... I...was just...not...@@<br>
...
aw.tagContent.enemy.wetClothes = [
  `@@.npc;Hah, what happened, did you threw your sippy cup on you? Or somebody mistook you with an urinal ahaha?@@<br><<stress 10 "Wet Clothes Convo">>
...
aw.tagContent.enemy.lightPheromones = [
  ...
  <<else>><<set aw.npc[setup.interact.status.npc].rship.likePC += 3 >><<set aw.npc[setup.interact.status.npc].rship.lovePC += 3 >><</if>><<include [[NPCinteraction-EnemyContinue]]>>`,
];
...
aw.tagContent.enemy.hairyPits = [
  `<<set aw.npc[setup.interact.status.npc].rship.lovePC -= 5 >><<print aw.npc[setup.interact.status.npc].main.name>> noticed your armpit bushes.<br><<stress 10 "Hairy armpits convo">>
...
aw.tagContent.enemy.clownMakeup = [
  `<<stress 15 "Clown makeup convo">><<print aw.npc[setup.interact.status.npc].main.name>> starts laughing.<br>
...
aw.tagContent.enemy.athleticClothes = [
  ...
  <<link "Well, fuck you too.">><<run setup.interact.exit()>><</link>><<happy -1 "Argument about athletic clothes">>
  `,
];

aw.tagContent.enemy.kinkyClothes = [
  `@@.npc;How does your streetwalker job going?@@<br><<stress 8 "Kinky clothes convo">>
