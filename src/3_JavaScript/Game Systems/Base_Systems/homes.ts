...
setup.home.apartmentDesc = function(T: 1 | 2 | 3 | 4 | 5, L: 1 | 2 | 3 | 4 | 5, F: 1 | 2 | 3 | 4 | 5, U: 1 | 2 | 3 | 4 | 5): string {
  ...
  const finish = [
    ...
    "is fairly cheap, but in most areas it does a decent-enough job of avoiding looking blatantly cheap and low-quality. While there's little in the way of luxury or creature-comforts, it does at least have all the necessities.",
  ...
  const upkeep = [
    ...
    "The place doesn't look brand-new, but it doesn't seem like there have been very many tenants living here since it was last renovated. It has the gentle wear that comes with occupancy, but nothing that appears run-down or that looks unsightly.",
