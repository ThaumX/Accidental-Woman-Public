...
interface Tattoo {
  face: tattooLib[] | false;
  neck: tattooLib[] | false;
  shoulderLeft: tattooLib[] | false;
  shoulderRight: tattooLib[] | false;
  armLeft: tattooLib[] | false;
  armRight: tattooLib[] | false;
  palmLeft: tattooLib[] | false;
  palmRight: tattooLib[] | false;
  breast: tattooLib[] | false;
  belly: tattooLib[] | false;
  pubic: tattooLib[] | false;
  thighLeft: tattooLib[] | false;
  thighRight: tattooLib[] | false;
  calfLeft: tattooLib[] | false;
  calfRight: tattooLib[] | false;
  feetLeft: tattooLib[] | false;
  feetRight: tattooLib[] | false;
  backUpper: tattooLib[] | false;
  backLower: tattooLib[] | false;
  butt: tattooLib[] | false;
  asshole: tattooLib[] | false;
  vagina: tattooLib[] | false;
}
...
interface DataFert {
  ...
  iud: boolean;
  aftOvulate: boolean;
  dta?: [number, number, number, number, number, number, number, boolean, number, number, number, number, number, number, number, number, number, number, number, boolean, boolean, boolean]
}
...
interface DataStatus {
  ...
  nutrition?: Nutrition;
  exercise?: number;
  data?: [number, number, string, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, boolean, number, number, boolean, boolean, boolean, number, number, boolean, number, number, number, number, number, number, number?];
}
...
interface DataRship {
  ...
  pcSlept: number;
  rejected?: boolean;
  data?: [boolean, boolean, boolean, boolean, boolean, boolean, boolean, number, number, number, number, number, number, number, number, number, number, number, number, number, number, boolean, number, string, number, number, number, number, number, number, number];
}
...
interface DataBody {
  ...
  botATR: number;
  ATR: number;
  dta?: [string, string, number, number, number, number, number, number, number, number, number, number, number, string, string, string, number, string, string, number, number, number, number, string, number, number, number, string];
}
...
interface DataTits {
  ...
  silicone: number;
  boob?: [number, number, number, number, number, number];
  base: DataBase;
  lact: DataLact;
}
