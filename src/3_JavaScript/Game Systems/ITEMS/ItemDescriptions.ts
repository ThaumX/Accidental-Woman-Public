...
aw.invItems.info = {
  ...
  "Model 1911": "Designed over 100 years ago, the Simpson's Armory Model 1911 is still around, and has been copied, customized, and modified by countless firearms manufacturers over the decades. While there's no single reason for the design's persistance, and newer designs have surpassed it in every category but nostalgia, it remains a functional and effective weapon.<br><br>Ammunition: .45 ACP | 8 rounds | Semi Auto",
  ...
  "Soy milk": "Cheap imitation made of soy, pretty widespread milke substitute after Furious cow disease pandemic.",
  ...
  "Ben Wa balls": "Two hollow balls containing wieghts that roll around for inserting into the vagina.",
