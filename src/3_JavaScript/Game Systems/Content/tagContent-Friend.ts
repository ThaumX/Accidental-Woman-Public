...
<<include [[NPCinteraction-FriendsTag]]>>`,
...
aw.tagContent.friend.nakedBottom = [
  ...
  @@.pc;Do you like it?@@<br><<arouse 2>><<orhas slut>><<arouse 2>>You can't but enjoy the attention to your naked bottom and pussy.<br><<orhas liberate>>You feel pretty comfortable with your lower part naked.<br><<orhas shame>><<stress 10>>You feel terribly insecure and going tomato red from embarassment.<br><<arouse -2>>@@.mono;How did I ever allow that to happen? I want just die right now.@@<br><<or>><<stress 7>>You feel pretty uncomfortable being exposed like this even with a friend.<br><<arouse -1>><</has>>
  <<dialogchoice>>
...
aw.tagContent.friend.NakedBottomCool = [
  ...
  <<include [[NPCinteraction-FriendsTag]]>><</if>>
  `,
];
aw.tagContent.friend.NakedBottomPresentRefuse = [
  ...
  <<include [[NPCinteraction-FriendsTag]]>><</link>>
  `,
];
aw.tagContent.friend.practNakedBottom = [
  ...
  @@.mono;I am pretty sure <<print aw.npc[setup.interact.status.npc].main.name>> likes the view, hehe.@@<br><<orhas shame>><<arouse -2>><<stress 5>>which makes you really nervous.<br>@@.mono;I shoudn't dress like that in a first place, oh, what I was even thinking about?@@<br><<or>><<stress 3>>which makes you feel uneasy.<br>
...
aw.tagContent.friend.clownMakeupSad = [
  `<<set aw.npc[setup.interact.status.npc].rship.likePC += 5 >><<stress 5>>
...
aw.tagContent.friend.stressedAbit = [
  `<<has extro>>@@.pc;Yeah, I am under a pressure lately. Work and everything in general you know. Don't know if I can deal with all this much longer...<<stress -5>>@@<<or>>@@.pc;Yeah, I am under a pressure lately.@@<</has>><<set aw.npc[setup.interact.status.npc].rship.likePC += 5 >><br>
