...
setup.library.initSA = function() {
  ...
  setup.library.sexact = {
    ...
    suckNipples: {
      standard: [
        `Placing your hand on one of <<= ↂ.T.main.name>>’s <<n _t 'breasts.n'>>, you lean in and engulf the <<n _t nipple.n>> with your <<p lips.n>>. Swirling your tongue around <<his>> <<n _t 'nipple.n'>>, you begin groping at the other <<n _t 'breast.n'>> with your free hand, kneading your way to the <<n _t 'nipple.n'>>. You begin sucking more firmly, squeezing the <<n _t nipwidth.q>> flesh between your <<p lips.q>> lips while you likewise increase the intensity of your hand’s ministrations on <<his>> other <<n _t 'nipple.n'>>. <<if ↂ.T.status.milk > 0>>Your efforts have started the flow of milk, <<his>> fresh cream <<if ↂ.T.status.milk < 3 || ↂ.T.body.lactation  < 2>>leaking into<<elseif ↂ.T.body.lactation < 4>>filling<<else>>flooding<</if>> your mouth and wetting your fingers.<</if>>`,
      ],
    },
    cupBalls: {
      standard: [
    ...
    rubAgainstTarget: {
      standard: [
        `Moving in close, you press yourself against him, putting as much of your nude body against <<n _t "hisher.q">> as you can manage. You moan as you move your bare, <<n _t "tone.q">> frame against <<n _t "hishers.q">>, the flesh of <<n _t "hisher.q">> <<n _t "fat.q">> body pressing against yours. You make sure to push your <<p breasts.n>> into him, loving the feel of your <<p nipples.n>> rubbing against <<n _t "hisher.q">> <<n _t "chest.n">>.`,
      ],
    },
    grindVulvaAgainst: {
      standard: [
